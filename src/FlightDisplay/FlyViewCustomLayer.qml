...
Item {
	...
	QGCButton {
        ...
        anchors.leftMargin: ScreenTools.defaultFontPixelWidth * 9.62
	...
	QGCButton {
		...
		anchors.left: mavlinkConsoleButton.left
		anchors.top: mavlinkConsoleButton.bottom
	...
	QGCButton {
		id: mavlinkInspectorButton

		text: qsTr("MAVLink Inspector")
		z: QGroundControl.zOrderWidgets

		anchors.left: mavlinkConsoleButton.left
		anchors.top: logDownloadButton.bottom
		anchors.topMargin: ScreenTools.defaultFontPixelHeight * 0.5

		onClicked: {
			mainWindow.createrWindowedAnalyzePage(
				qsTr("MAVLink Inspector"),
